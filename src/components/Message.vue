...
export default {
  ...
  methods: {
      ...
      if (result) {
        this.shares[index].like.forEach((element) => {
          if (element.user_id == this.$store.state.user.id) {
            axios({
              method: "delete",
              url: "https://git.heroku.com/agile-waters-38693.git//api/like",
              data: {
        ...
        axios
          .post("https://git.heroku.com/agile-waters-38693.git//api/like", {
            share_id: this.shares[index].item.id,
            user_id: this.$store.state.user.id,
          })
          .then((response) => {
    ...
    del(index) {
      axios
        .delete(
          "https://git.heroku.com/agile-waters-38693.git//api/shares/" +
